...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "font-sans text-base leading-snug font-semibold group-data-[size=sm]/card:text-sm tracking-tight",
        className
      )}
      {...props}
    />
...
function CardAction({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "col-start-2 row-span-2 row-start-1 self-start justify-self-end text-muted-foreground focus:text-foreground",
        className
      )}
      {...props}
    />
...
function CardContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("px-4 group-data-[size=sm]/card:px-3 text-card-foreground/90", className)}
      {...props}
    />
  )
}
